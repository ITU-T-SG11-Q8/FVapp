...
from SPIGA.spiga.data.loaders.augmentors.modern_posit import PositPose
from SPIGA.spiga.data.loaders.augmentors.heatmaps import Heatmaps
from SPIGA.spiga.data.loaders.augmentors.boundary import AddBoundary
from SPIGA.spiga.data.loaders.augmentors.landmarks import HorizontalFlipAug, RSTAug, OcclusionAug, \
