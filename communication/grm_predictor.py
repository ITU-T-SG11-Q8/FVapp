...
class GRMPredictor:
    def __init__(self, config_path, checkpoint_path, relative=False, adapt_movement_scale=False, enc_downscale=1, is_client=False, in_port=9999, out_addr='127.0.0.1', out_port=9999, device=None):
